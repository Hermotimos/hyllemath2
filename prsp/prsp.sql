...
-- Gracz ma dostęp do Tagów należący do TagGroup których jest autorem + gdzie authorid NULL (=defaultowe)
...
CREATE TABLE FirstNameToFirstNameTagLink (
  id INT GENERATED BY DEFAULT AS IDENTITY,
  firstnameid INT NOT NULL,
  firstnametagid INT NOT NULL,
  -- ---------------------
  CONSTRAINT cha_firstnametofirstnametag_pk PRIMARY KEY (id)
);
...
CREATE TABLE cha.CharacterVersion (
  ...
  fullname VARCHAR(100)
    ...
    -- Django unmanaged: fullname = CharField(db_column='fullname', editable=False)
